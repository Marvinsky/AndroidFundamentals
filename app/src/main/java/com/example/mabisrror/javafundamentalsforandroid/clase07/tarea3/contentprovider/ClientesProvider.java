...
public class ClientesProvider extends ContentProvider {
    ...
    private static final String uri =
            "content://com.example.mabisrror.javafundamentalsforandroid/clientes";
    ...
    //BD
    private ClientesSqliteHelper clidb;
    ...
    static {
        ...
        uriMatcher.addURI("com.example.mabisrror.javafundamentalsforandroid", "clientes", CLIENTES);
        uriMatcher.addURI("com.example.mabisrror.javafundamentalsforandroid", "clientes/#", CLIENTES_ID);
    }
    ...
    public boolean onCreate() {
        clidb = new ClientesSqliteHelper(getContext(), DB_NOMBRE, null, DB_VERSION);
        return true;
    }
